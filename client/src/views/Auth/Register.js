            ...
            <Container component="main" maxWidth="xs">
                ...
                <div className={classes.paper}>
                    ...
                    <Fade in={error ? true : false}>
                        <Alert style={{marginTop: '10px', display: error ? '' : 'none'}}
                    ...
                    <form className={classes.form} noValidate>
                        ...
                        {/* Need to link social when user already authed (in settings) */}
                        {/*<Typography style={{display: 'flex', justifyContent: 'center', marginTop: '5px'}} component="h3"*/}
                        {/*            variant="h10">*/}
                        {/*  Sign up with social:*/}
                        {/*</Typography>*/}
